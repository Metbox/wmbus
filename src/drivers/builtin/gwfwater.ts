// gwfwater — auto-generated registry stub.
...
export const gwfwater = defineDriver({
  ...
  linkModes: ["T1"],
  mvt: [
    { manufacturer: flagToManufacturer("GWF"), version: 0x0e, type: 0x01 },
    { manufacturer: flagToManufacturer("GWF"), version: 0x07, type: 0x3c },
  ],
