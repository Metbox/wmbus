// evo868 — auto-generated registry stub.
...
export const evo868 = defineDriver({
  ...
  linkModes: ["T1"],
  mvt: [
    { manufacturer: flagToManufacturer("MAD"), version: 0x06, type: 0x50 },
    { manufacturer: flagToManufacturer("MAD"), version: 0x07, type: 0x50 },
    { manufacturer: flagToManufacturer("MAD"), version: 0x16, type: 0x50 },
  ],
