...
export const compact5 = defineDriver({
  ...
  linkModes: ["T1", "C1"],
  mvt: [
    { manufacturer: TCH, version: 0x04, type: 0x45 },
    { manufacturer: TCH, version: 0xc3, type: 0x45 },
    { manufacturer: TCH, version: 0x43, type: 0x22 },
    { manufacturer: TCH, version: 0x43, type: 0x45 },
    { manufacturer: TCH, version: 0x43, type: 0x39 },
  ],
