// fhkvdataiii — auto-generated registry stub.
...
export const fhkvdataiii = defineDriver({
  ...
  linkModes: ["T1"],
  mvt: [
    { manufacturer: flagToManufacturer("TCH"), version: 0x80, type: 0x69 },
    { manufacturer: flagToManufacturer("TCH"), version: 0x80, type: 0x94 },
  ],
