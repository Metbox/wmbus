// mkradio4 — auto-generated registry stub.
...
export const mkradio4 = defineDriver({
  ...
  linkModes: ["T1"],
  mvt: [
    { manufacturer: flagToManufacturer("TCH"), version: 0x62, type: 0x95 },
    { manufacturer: flagToManufacturer("TCH"), version: 0x62, type: 0x70 },
    { manufacturer: flagToManufacturer("TCH"), version: 0x72, type: 0x95 },
    { manufacturer: flagToManufacturer("TCH"), version: 0x72, type: 0x70 },
  ],
