...
export const izar = defineDriver({
  ...
  linkModes: ["T1"],
  mvt: [
    { manufacturer: DME, version: 0x05, type: 0x07 },
    { manufacturer: DME, version: 0x07, type: 0x06 },
    { manufacturer: DME, version: 0x07, type: 0x07 },
    { manufacturer: DME, version: 0x77, type: 0x07 },
    { manufacturer: DME, version: 0x86, type: 0x07 },
  ],
