 ...
 */
// itron — auto-generated registry stub.
...
export const itron = defineDriver({
  name: "itron",
  meterType: "WaterMeter",
  linkModes: ["T1"],
  mvt: [
    { manufacturer: flagToManufacturer("ITW"), version: 0x00, type: 0x07 },
    { manufacturer: flagToManufacturer("ITW"), version: 0x03, type: 0x07 },
    { manufacturer: flagToManufacturer("ITW"), version: 0x33, type: 0x07 },
    { manufacturer: flagToManufacturer("ITW"), version: 0x00, type: 0x16 },
  ],
