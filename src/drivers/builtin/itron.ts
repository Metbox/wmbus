...
export const itron = defineDriver({
  ...
  linkModes: ["T1"],
  mvt: [
    { manufacturer: flagToManufacturer("ITW"), version: 0x07, type: 0x00 },
    { manufacturer: flagToManufacturer("ITW"), version: 0x07, type: 0x03 },
    { manufacturer: flagToManufacturer("ITW"), version: 0x07, type: 0x33 },
    { manufacturer: flagToManufacturer("ITW"), version: 0x16, type: 0x00 },
  ],
