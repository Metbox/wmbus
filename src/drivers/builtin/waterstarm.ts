...
export const waterstarm = defineDriver({
  ...
  linkModes: ["T1"],
  mvt: [
    { manufacturer: flagToManufacturer("DWZ"), version: 0x06, type: 0x00 },
    { manufacturer: flagToManufacturer("DWZ"), version: 0x06, type: 0x02 },
    { manufacturer: flagToManufacturer("DWZ"), version: 0x07, type: 0x02 },
    { manufacturer: flagToManufacturer("EFE"), version: 0x07, type: 0x03 },
    { manufacturer: flagToManufacturer("EFE"), version: 0x07, type: 0x70 },
    { manufacturer: flagToManufacturer("DWZ"), version: 0x07, type: 0x00 },
  ],
