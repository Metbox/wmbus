...
First public release. Pure-TypeScript wireless M-Bus decoder, drop-in
...
API frozen as the three-function surface (`decodeWmbusHex`,
`listWmbusDrivers`, `analyzeWmbusHex`) plus `registerCustomDriver`. See
README for usage and `TODO.md` for the path to full upstream parity.
